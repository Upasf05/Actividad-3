...
class JuegoPPT: #Clase principal que convierte el código en uno con POO, los objetos serán las funciones (def), que interactuan entre sí
    def __init__(self, root): #Función init que define las variables y los ajustes de la interfaz gráfica
    ...
    def crear_interfaz(self): #Función que crea todos los botones y cuadros de texto
        #Mensajes de texto
        ...
        # Botones de opciones de piedra, papel o tijera
        ...
        # Campos de texto para mostrar resultados a través de mensajes 
    ...
    def jugar(self, opcion): #Función donde se ejecuta el juego
    ...
    def reiniciar(self): #Función para reiniciar el programa
...
if __name__ == "__main__": #Estructura para ejecutar la clase dentro del programa
    ...
    app = JuegoPPT(root) #Incopora en la ventana la clase con todas sus funciones
